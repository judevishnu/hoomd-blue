...
*/
TorsForceCompute::TorsForceCompute(std::shared_ptr<SystemDefinition> sysdef,
                                                     std::shared_ptr<ParticleGroup> group1, std::shared_ptr<ParticleGroup> group2)
    : ForceCompute(sysdef), m_group(group1), m_group(group2)
    {
    m_exec_conf->msg->notice(5) << "Constructing TorsForceCompute" << endl;
...
TorsForceCompute::~TorsForceCompute()
    {
    m_exec_conf->msg->notice(5) << "Destroying TorsForceCompute" << endl;
    }
...
*/
void TorsForceCompute::setTable(unsigned int type,
...
void TorsForceCompute::setParamsPython(std::string type, pybind11::dict params)
    {
